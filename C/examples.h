...
void smoothing( int numberofsmoothing, std::string &input,  std::string &output); 
void nonpacksmoothing ( int numberofsmoothing, std::string &inputfile,  std::string &outputfile);

// define traits
struct MyTraits : public OpenMesh::DefaultTraits
{
  /*  All other attributes are implicitly default traits*/
